...
namespace QuickVR
{
    ...
    public class QuickMirrorReflection_v2 : QuickMirrorReflectionBase
    {
        ...
        protected override void RenderReflection()
        {
            ...
            {
                //Matrix4x4 mat2 = cam.GetStereoProjectionMatrix(Camera.StereoscopicEye.Left);
                //Debug.Log("mat2 = " + mat2);
                //mat2[0, 0] *= 2;
                //mat2[1, 1] *= 2;
                //mat.SetMatrix("_mvpEyeLeft", mat2 * cam.GetStereoViewMatrix(Camera.StereoscopicEye.Left) * transform.localToWorldMatrix);

                //Matrix4x4 mat3 = cam.GetStereoProjectionMatrix(Camera.StereoscopicEye.Left);
                //Debug.Log("mat3 = " + mat3);
                //mat3[0, 0] *= 2;
                //mat3[1, 1] *= 2;
                //mat.SetMatrix("_mvpEyeRight", mat3 * cam.GetStereoViewMatrix(Camera.StereoscopicEye.Right) * transform.localToWorldMatrix);
